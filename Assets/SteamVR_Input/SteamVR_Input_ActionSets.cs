...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_RadioControls p_RadioControls;
        ...
        public static SteamVR_Input_ActionSet_RadioControls RadioControls
        {
            get
            {
                return SteamVR_Actions.p_RadioControls.GetCopy<SteamVR_Input_ActionSet_RadioControls>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_RadioControls = ((SteamVR_Input_ActionSet_RadioControls)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_RadioControls>("/actions/RadioControls")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.RadioControls};
        }
    }
}
